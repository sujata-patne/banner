...
if (!defined('UPLOAD')) {
	define('UPLOAD', "/var/www/akicon/Icon/Modules/bannermanage/uploads/");
}
...
if (!defined('SUCCESSLOGS')) {
	define('SUCCESSLOGS', APP . 'logs' . DS . 'Logs'. DS);
}


if (!defined('ERRORLOGS')) {
//	define('ERRORLOGS', APP . 'logs' . DS . 'ErrorLogs'. DS);
	define('ERRORLOGS', APP . 'logs' . DS . 'Logs'. DS);
}
